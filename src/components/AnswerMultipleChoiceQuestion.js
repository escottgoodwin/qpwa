...
import {ANSWER_QUESTION_MUTATION} from '../ApolloQueries'
...
class AnswerMultipleChoiceQuestion extends Component {
    ...
    render() {
      ...
      const { classes, id, choices, question } = this.props
...
export default withStyles(styles)(AnswerMultipleChoiceQuestion)
