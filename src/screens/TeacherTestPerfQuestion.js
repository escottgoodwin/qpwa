      ...
      return (
        ...
        <Query query={TEST_QUESTION_STATS_QUERY} variables={{ testId: test_id }}>
              {({ loading, error, data }) => {
                ...
                const bestQuestions = listSort1(testQuestionStats,'percentCorrect','desc')
                const worstQuestions = listSort1(testQuestionStats,'percentCorrect','asc')
...
export default withStyles(styles)(TeacherTestPerfQuestion)
