...
import TestHeaderTeacher from '../components/StudentTestTeacher'
  ...
  render() {
    ...
    <Query query={USER_QUESTIONS_QUERY} variables={{ testId }} fetchPolicy="cache-and-network">
        ...
        return (
          ...
          <TestHeaderTeacher classes={classes} test_id={testId} />
...
export default withStyles(styles)(TeacherTestQuestions)
